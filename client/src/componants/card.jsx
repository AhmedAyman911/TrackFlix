    ...
    >
      ...
      >
        ...
        <div className="p-3">
          ...
          {movie.vote_average ? movie.vote_average.toFixed(1) : "N/A"} <StarIcon sx={{ fontSize: 14 }} className="text-yellow-400" /> | {(movie.release_date || movie.first_air_date || '').slice(0, 4)} | {movie.original_language || movie.origin_country}
          </p>
        </div>
      </div>
    </div>
